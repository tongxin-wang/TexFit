...
from dataset.dfmm_spotlight import DFMMSpotlight
...
def main():
    ...
    for epoch in range(opt['num_epochs']):
        ...
        if epoch % opt['val_freq'] == 0:
            ...
            # save model
            model.save_network(
                f'{opt["path"]["models"]}/region_generation_epoch{epoch}.pth')
